...
//Identify Priority of Test 
//Caseshttp://secure.smartbearsoftware.com/samples/TestComplete11/WebOrders/Process.aspx
//TC 1: Saucedemo Username1
//(Data Provider - Quantity:, Customer name:,Street: City:, State: ,Zip:,Card:,Card Nr:, Expire date )
...
//Step 5: Make an order for two user,enter all the information for both users
//(Quantity:, Customer name:,Street: City:, State: ,Zip:,Card:,Card Nr:, Expire date)
